...
class User(Base):
    ...
    role = Column(String(20), nullable=False, default=UserRole.LANDLORD, index=True)
...
class Room(Base):
    ...
    status = Column(String(20), nullable=False, default=RoomStatus.AVAILABLE)
...
class Payment(Base):
    ...
    payment_type = Column(String(20), nullable=False, default=PaymentType.RENT)
